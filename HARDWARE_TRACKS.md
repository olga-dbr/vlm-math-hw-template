...
loss конечный и заметно не взрывается
```
...
Треки отделяют знание архитектуры и пайплайна от доступа к железу. CPU-only студенты могут получить максимум за корректную реализацию, а студенты с GPU могут сделать более глубокий ML-проект и сравнить качество.
